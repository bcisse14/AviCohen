...
export default function ContactPage() {
  ...
  return (
    <>
      ...
      <section>
        <div className="container-site grid gap-12 py-16 sm:py-20 lg:grid-cols-2 lg:items-start">
          ...
          <div className="space-y-6">
            <div className="rounded-2xl border border-border bg-surface p-7 sm:p-8">
              <Eyebrow>Coordonnées & accès</Eyebrow>
              ...
              <h2 className="mt-10 text-xl text-ink">Plan d&apos;accès</h2>
              <p className="mt-2 text-sm leading-relaxed text-muted">
